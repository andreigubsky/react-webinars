...
//     </ul>
//     <ul>
//       {arrObj.map((el, index)=><li key={index}>{JSON.stringify(el)}</li>)}
//     </ul>
//     <div><p>{JSON.stringify(obj)}</p></div>
//     <div><p>{obj.age}</p></div>
//     {isOnline && <p>Hello</p>}
//     {isOnline?<p>{userName} <strong>online</strong></p>:<p>{userName} <strong>offline</strong></p>}
//     {null}
//     {undefined}
//     {true}
//     {false}
